...
//
// WHAT THIS IS. A held-out evaluation of a deterministic verifier. Each request
...
//
// WHY THE HELD-OUT CLAIM IS DEFENSIBLE. The policy was written and frozen before
...
func run() error {
	...
	p("# Arm D results — the guard as a verifier, on a held-out corpus\n\n")
	...
	p("**Held out by construction.** The policy was frozen in `fb87b12`\n")
